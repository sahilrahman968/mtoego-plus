    ...
    <div ref={containerRef} className="relative">
      <div className="flex">
        <button
          ...
          onClick={() => setOpen((p) => !p)}
          disabled={disabled}
          className="flex items-center gap-1 px-3 py-2.5 text-sm border border-border border-r-0 rounded-l-lg bg-card hover:bg-card-hover transition-colors shrink-0 disabled:opacity-50"
        >
